...
# 参考
# https://kuri-megane.hatenablog.jp/entry/2018/06/28/100000#OpenCV--Python--Optical-Flow-%E3%81%A7%E7%89%A9%E4%BD%93%E8%BF%BD%E8%B7%A1%E3%81%97%E3%81%A6%E3%81%BF%E3%82%8B
...
cap = cv2.VideoCapture("optical_fllow/data/20211207/d4p8_回転.avi")
...
while True:
    ...
    for rank, (prev_p, next_p) in enumerate(zip(good_old, good_new)):
        ...
        prev_x, prev_y = prev_p.astype(np.uint).ravel()
        next_x, next_y = next_p.astype(np.uint).ravel()
