...
(cl:defmethod cl:initialize-instance :after ((m <Float64Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rubbing_hand-msg:<Float64Array> is deprecated: use rubbing_hand-msg:Float64Array instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Float64Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rubbing_hand-msg:data-val is deprecated.  Use rubbing_hand-msg:data instead.")
  (data m))
