...
plt.scatter(x=df_FLAT["frequency"], y=df_FLAT["error"]/60, color="blue", label="FLAT")
plt.scatter(x=df_CAVS["frequency"], y=df_CAVS["error"]/60, color="red", label="CAVS")
...
# plt.savefig("/home/suzuki/ros_ws/ay_tools/fingervision/suzuki/rubbing_hand/data/0510/result2.png")
plt.show()